...
A TS that accepts to register any valid claim offers limited value to verifiers: the baseline transparency guarantee ensures completeness of audit, which can help detect equivocation.
